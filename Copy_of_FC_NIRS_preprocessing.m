...
% Last Modified by GUIDE v2.5 29-May-2014 17:43:45
...
%display Data
%displayData();
set(handles.output_directory,'String',cd);
...
% --- Executes on mouse press over axes background.
function axesDisplayData_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to axesDisplayData (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
